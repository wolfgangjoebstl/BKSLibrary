<?
 ...
 /* wenn die FS20-STR einen Heizkoerper ansteuert, gleich wieder den Status aendern */
 
Include("AllgemeineDefinitionen.inc.php");

$EinschaltdauerID = CreateVariableByName($_IPS['SELF'], "Einschaltdauer", 1);
$Temp1AnfangID = CreateVariableByName($_IPS['SELF'], "StartTemperatur1", 2);
$Temp2AnfangID = CreateVariableByName($_IPS['SELF'], "StartTemperatur2", 2);
$TempErhoehungID = CreateVariableByName($_IPS['SELF'], "DeltaTemperatur", 2);
