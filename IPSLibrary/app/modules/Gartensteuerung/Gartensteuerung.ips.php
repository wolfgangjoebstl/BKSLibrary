 ...
 ****************************************************************/
 ...
 if ($_IPS['SENDER']=="WebFront")
	...
	if ($variableID == $GiessAnlageID) { echo "Giessanlage Betriebsart Umschaltung bearbeiten."; }
	$value=$_IPS['VALUE'];
	...
	switch ($_IPS['VALUE'])
		...
		case "0":  /* Aus */
      		IPS_SetEventActive($giesstimerID,false);
      		PS_SetEventActive($timerDawnID,false);
...
*************************************************************/
	...
	$parentid  = IPSUtil_ObjectIDByPath('Program.IPSLibrary.data.modules.Gartensteuerung.Gartensteuerung-Auswertung');
