...
echo "\n";
  ...
  *************************************************************/
	...
	echo "\n";
	echo "***********************************************************************************************\n";
	echo "EvaluateMotion, Bewegungsmelder und Helligkeitssesor Handler wird ausgeführt, Contact Handler in einem eigenen Script:\n";
    echo "--------------------------------------------------------------------------------------\n";
    if ( (function_exists('deviceList')) )
        ...
        $result = $componentHandling->installComponentFull(deviceList(),["TYPECHAN" => "TYPE_METER_CLIMATE","REGISTER" => "BRIGHTNESS"],'IPSComponentSensor_Motion','IPSModuleSensor_Motion,',$commentField,true);               // true mit Debug
        $result = $componentHandling->installComponentFull(deviceList(),["TYPECHAN" => "TYPE_BRIGHTNESS","REGISTER" => "BRIGHTNESS"],'IPSComponentSensor_Motion','IPSModuleSensor_Motion,',$commentField,true);               // true mit Debug
        echo "---------------------------------------------------------------\n";
