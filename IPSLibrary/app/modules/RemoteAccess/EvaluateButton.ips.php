 ...
 *  es erfolgt eine individuelle Ermittlung
 */
...
*************************************************************/
  ...
  *************************************************************/
    ...
    if ( (function_exists('deviceList')) )
        ...
        //print_r($result);
        $result = $componentHandling->installComponentFull(deviceList(),["TYPECHAN" => "TYPE_BUTTON"],'IPSComponentSensor_Remote','IPSModuleSensor_Remote,',$commentField, true);				/* true ist Debug, Bewegungsensoren */
        
        //$result = $componentHandling->getComponent(deviceList(),["TYPECHAN" => "TYPE_BUTTON"],"Array",true);				/* true ist Debug, Bewegungsensoren */
        print_r($result);
        }
    elseif (function_exists('HomematicList'))
		{
        echo "Taster von verschiedenen Geräten auf Basis Homematiclist() werden registriert.\n";
