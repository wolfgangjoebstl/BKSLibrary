...
$LW12_LibraryId = 14824 /*[Program\Debug\RGB-LED\LW12-Library]*/;
...
$modulID = @IPS_GetInstanceIDByName("LW12LEDController", $parentID);
echo "ModulID :".$parentId." ".$modulID."\n";
...
if(!IPS_InstanceExists($modulID))
   {
	...
	IPS_SetName($modulId, "LW12LEDController");
...
IPS_SetVariableCustomAction($var, $LW12_LibraryId);
		...
		IPS_SetEventScript($eventId, "require(\"scripts/\".GetValue(IPS_GetObjectIDByName(\"!LW12_Library\",  IPS_GetParent(\$_IPS['VARIABLE']))).\".ips.php\");\n\nLW12_PowerToggle();");
...
IPS_SetVariableCustomAction($var, $LW12_LibraryId);
		...
		IPS_SetParent($eventId, $var);         		//Ereignis zuordnen
		IPS_SetEventActive($eventId, true);          //Ereignis aktivieren
		IPS_SetEventScript($eventId, "require(\"scripts/\".GetValue(IPS_GetObjectIDByName(\"!LW12_Library\",  IPS_GetParent(IPS_GetParent(\$_IPS['VARIABLE'])))).\".ips.php\");\n\nLW12_CtrlPrgToggle();;");
