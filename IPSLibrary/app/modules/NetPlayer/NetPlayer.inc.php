<?
   ...
   /** @}*/
	...
	function NetPlayer_SwitchToRadio($forceLoad=false) {
		...
		IPSLogger_Inf(__file__, "SwitchToRadio Play RadioStation '$radiotitel', Url='$radiourl'");
		NetPlayer_Power(true);
	...
	function NetPlayer_PlayRadio($radiourl, $radiotitel) {
		IPSLogger_Inf(__file__, "NetPlayer Play RadioStation '$radiotitel', Url='$radiourl'");
